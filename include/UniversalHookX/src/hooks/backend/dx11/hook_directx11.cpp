...
namespace DX11 {
    void Hook(HWND hwnd) {
        ...
        if (g_pd3dDevice) {
            ...
            oCreateSwapChain                 = reinterpret_cast<decltype(oCreateSwapChain)>(fnCreateSwapChain);
            oCreateSwapChainForHwnd         = reinterpret_cast<decltype(oCreateSwapChainForHwnd)>(fnCreateSwapChainForHwndChain);
            oCreateSwapChainForCoreWindow   = reinterpret_cast<decltype(oCreateSwapChainForCoreWindow)>(fnCreateSwapChainForCWindowChain);
            oCreateSwapChainForComposition  = reinterpret_cast<decltype(oCreateSwapChainForComposition)>(fnCreateSwapChainForCompChain);
            ...
            // DetourAttach(reinterpret_cast<PVOID*>(&oCreateSwapChain), reinterpret_cast<PVOID>(hkCreateSwapChain));
            // DetourAttach(reinterpret_cast<PVOID*>(&oCreateSwapChainForHwnd), reinterpret_cast<PVOID>(hkCreateSwapChainForHwnd));
            // DetourAttach(reinterpret_cast<PVOID*>(&oCreateSwapChainForCoreWindow), reinterpret_cast<PVOID>(hkCreateSwapChainForCoreWindow));
            // DetourAttach(reinterpret_cast<PVOID*>(&oCreateSwapChainForComposition), reinterpret_cast<PVOID>(hkCreateSwapChainForComposition));

            DetourAttach(reinterpret_cast<PVOID*>(&oPresent), reinterpret_cast<PVOID>(hkPresent));
            DetourAttach(reinterpret_cast<PVOID*>(&oPresent1), reinterpret_cast<PVOID>(hkPresent1));

            // DetourAttach(reinterpret_cast<PVOID*>(&oResizeBuffers), reinterpret_cast<PVOID>(hkResizeBuffers));
            // DetourAttach(reinterpret_cast<PVOID*>(&oResizeBuffers1), reinterpret_cast<PVOID>(hkResizeBuffers1));
